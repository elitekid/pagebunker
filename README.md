...
- **Save this article** — toolbar button, `Alt+Shift+L` (`Option+Shift+L` on Mac), or right-click menu. Title, author, publish date, and body are extracted; ads, menus, and comments are left out. If the body cannot be extracted, the link is saved instead.
